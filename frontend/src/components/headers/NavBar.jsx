...
const NavBar = () => {
    ...
    // useEffect(() => {
    //     const darkPackage = 'dark';
    //     const root = window.document.documentElement;

    //     if (isDarkMode) {
    //         root.PackageList.add(darkPackage);
    //     } else {
    //         root.PackageList.remove(darkPackage);
    //     }
    // }, [isDarkMode]);
    useEffect(() => {
            ...
            <div className="lg:w-[95%] mx-auto sm:px-6 lg:px-6">
                <div className="flex px-4 items-center justify-between py-4">
                    ...
                    <div onClick={() => navigate('/')} className="flex-shrink-0 cursor-pointer pl-7 md:p-0 flex items-center">
                        <div className={``}>
                            <h1 className='text-2xl font-Cinzel  inline-flex gap-3  items-center font-bold'>WorkoutMaster <img src="/gym-logo.png" alt="" className='w-6 h-6' /></h1>
